...
export default function CookiesShowcase() {
    ...
    return (
        <section
            id="cookies"
            ref={containerRef}
            className="relative w-full min-h-screen bg-cream text-espresso py-16 sm:py-24 md:py-32"
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <h2 className="relative z-10 text-3xl sm:text-5xl md:text-7xl font-display mb-12 sm:mb-16 md:mb-24 text-center text-espresso drop-shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
                    {cookies.map((cookie, i) => (
                        <div
                            ...
                            className="group aspect-[3/4] bg-white rounded-2xl relative p-6 sm:p-8 flex flex-col justify-between cursor-pointer transition-transform duration-100 ease-linear transform-gpu overflow-hidden"
                            onMouseMove={(e) => {
